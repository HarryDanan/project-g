...
var mp3snd 	= "../assets/sound/bgm_game.mp3";	// MP3 FILE
//var oggsnd 	= "../js/audio-file.ogg";	// OGG FILE
...
document.write('<table hidden style="border-collapse:collapse; border-spacing: 0px; margin: '+centerply+'; padding: 0px; border: #'+bordcolor+' '+borderw+'px solid;"><tr><td style="vertical-align: middle; text-align: center; padding: 0px;">');
